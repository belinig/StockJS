...
angular.module("Watch")
    .controller('findStockCtrl', function ($scope, $uibModalInstance, syncData, $interval, $timeout, $window, $filter, $uibModal, pollInterval, SRV_getWatchlistQuotes, SRV_saveWatchlist, SRV_getDateTime, SRV_findASXStocks, Watchlist) {
        ...
        console.log("findStockCtrlId=" + $scope.findStockCtrlId + ", scope.id=" + $scope.$id);
        scopes.push($scope);

        $scope.save = function (stockCode) {
            syncData = stockCode;
            $uibModalInstance.close(stockCode);
        };
        ...
        $scope.findASXStock = function (match) {
        ...
        $scope.pageChangeHandler = function (num) {
            console.log('stocks page changed to ' + num);
        };
 ...
 */
    ...
    .directive("dirPaginationControls", ['paginationService', 'paginationTemplate', function (paginationService, paginationTemplate) {
        var numberRegex = /^\d+$/;
    ...
    .service("paginationService", function paginationService() {
    ...
    .provider("paginationTemplate", function paginationTemplateProvider() {
    ...
    .run(['$templateCache', function dirPaginationControlsTemplateInstaller($templateCache) {
